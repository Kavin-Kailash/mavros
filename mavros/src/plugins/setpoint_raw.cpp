...
// MPC_CONTROL adding msg include
...
public:
	...
	void initialize(UAS &uas_)
	{
		...
		// MPC_CONTROL initializing subscriber and plugin parameters while running checks
...
private:
	...
	// MPC_CONTROL declaring subscriber and global variables
	...
	void rpyt_cb(const mav_msgs::RollPitchYawrateThrustConstPtr msg) {
      ...
      uint8_t type_mask = mavros_msgs::AttitudeTarget::IGNORE_ROLL_RATE | mavros_msgs::AttitudeTarget::IGNORE_PITCH_RATE;
